...
public class PatientBanner {
	...
	public PatientBanner(String iD, String name, String gender, int age, String birthDate, String lengthStay, String eD,
			String allergies, String eID, String triage, String risks) {
		this.ID = iD;
		this.name = name;
		this.gender = gender;
		this.age = age;
